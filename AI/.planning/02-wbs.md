...
| | 3.3.2 FeedbackScreen | 점수 게이지 + 강점/약점 카드 + STAR 힌트 | ✅ |
| | 3.3.3 ResultScreen | 전체 결과 + 질문별 ExpansionTile + 공유 | ✅ |
...
| | 4.1.2 LoginScreen | 탭바 로그인/회원가입 UI | ✅ |
| 4.2 Firestore | 4.2.1 데이터 구조 설계 | users/{uid}/sessions/{sid} | ✅ |
| | 4.2.2 SessionRepository | 저장/조회 CRUD | ✅ |
| 4.3 히스토리 | 4.3.1 HistoryScreen | 꺾은선 그래프 + 취약점 태그 + 세션 목록 | ✅ |
| | 4.3.2 SessionDetailScreen | 레이더 차트 + 답변 카드 + 다시 연습하기 | ✅ |
...
| 5.2 테스트 | 5.2.1 FeedbackModel 테스트 | JSON 파싱, score clamp, toJson roundtrip | ✅ |
| | 5.2.2 SessionModel 테스트 | fromJson/toJson, missing fields | ✅ |
...
| 기능 | 설명 | 상태 |
|------|------|------|
| 연속 학습 뱃지 | 홈화면 🔥 스트릭 배지 (SharedPreferences) | ✅ |
| MCP 설정 | Notion + Sequential Thinking + Context7 | ✅ |
| Sub-Agent 정의 | AGENTS.md — 3개 에이전트 | ✅ |
